...
temp_dump = '/data/Aldhani/eoagritwin/et/Sentinel3/LST/SharpEvap/Brandenburg/TileGAP/'
...
#                     path_to_inci, path_to_lst, trash_path, '20190401', '20190410', ['maxLST'], ['S2only'], 3])
...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=ncores)(delayed(Sharp_Evap)(job[0], job[1], job[2], job[3], job[4], job[5], job[6],
                                                job[7], job[8], job[9], job[10], job[11], job[12], job[13]) for job in joblist)
