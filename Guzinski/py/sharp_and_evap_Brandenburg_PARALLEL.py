...
for idx, tile_to_process in enumerate(tiles_to_process):
    joblist.append([tile_to_process, temp_dump, path_to_slope, path_to_aspect, path_to_agro, path_to_force,
                    '20190401', '20190801', ['minVZA'], ['S2only'], 2])
...
if __name__ == '__main__':
    ...
    Parallel(n_jobs=ncores)(delayed(Sharp_Evap)(job[0], job[1], job[2], job[3], job[4], job[5], job[6], job[7], job[8], job[9], job[10]) for job in joblist)
